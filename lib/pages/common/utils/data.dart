...
class Countries {
  ...
  static const List<Country> _list = [
    ...
    Country(name: "Curacao", code: "CW", dialCode: "+599", flag: "🇨🇼"),
    ...
    Country(name: "Réunion", code: "RE", dialCode: "+262", flag: "🇷🇪"),
    ...
    Country(name: "Saint Helena", code: "SH", dialCode: "+247", flag: "🇸🇭"),
    Country(
    ...
    Country(name: "Åland Islands", code: "AX", dialCode: "+358", flag: "🇦🇽"),
  ];
}
